...
<div id="menu" class="menu-right">
    <ul>
        ...
        <form class="menu-search" method="POST" action="<spring:url value="/search"/>">
            <div class="form-group header">
                <i class="icon-search searchico"></i>
                <input type="text" placeholder="Blog Search" name="search">
        ...
        <li class="submenu">
            ...
            <ul class="submenu-list">
                <li><a href="?lang=uk">Ukrainian<span class="badge">1</span></a></li>
