...
<div class="modal fade" id="changeLanguageModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <a href="?lang=uk"><img src="${pageContext.servletContext.contextPath}/resources/img/flags/ukraine.gif" width="100" alt="Ukraine"></a>
        <a href="?lang=en"><img src="${pageContext.servletContext.contextPath}/resources/img/flags/england.gif" width="108" alt="England"></a>
      </div>
      <div class="modal-footer">
